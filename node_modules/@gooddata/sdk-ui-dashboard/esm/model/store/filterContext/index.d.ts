...
export declare const filterContextActions: import("@reduxjs/toolkit").CaseReducerActions<{
    setFilterContext: import("@reduxjs/toolkit").CaseReducer<import("./filterContextState").FilterContextState, {
        payload: {
            filterContextDefinition: import("@gooddata/sdk-backend-spi").IFilterContextDefinition;
            attributeFilterDisplayForms: import("@gooddata/sdk-backend-spi").IAttributeDisplayFormMetadataObject[];
            filterContextIdentity?: import("@gooddata/sdk-backend-spi").IDashboardObjectIdentity | undefined;
        };
        type: string;
    }>;
    ...
    addAttributeFilterDisplayForm: import("@reduxjs/toolkit").CaseReducer<import("./filterContextState").FilterContextState, {
        payload: import("@gooddata/sdk-backend-spi").IAttributeDisplayFormMetadataObject;
        type: string;
    }>;
