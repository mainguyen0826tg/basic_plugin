...
import { IChartOptions, ISeriesItem, IStackMeasuresConfig, IYAxisConfig } from "../../typings/unsafe";
 ...
 * @param config
 */
export declare function getParentAttributeConfiguration(chartOptions: IChartOptions, config: HighchartsOptions): {
    xAxis: XAxisOptions[];
};
