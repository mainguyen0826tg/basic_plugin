...
import { JsonApiAnalyticalDashboardOutList, JsonApiAttributeOutList, JsonApiDashboardPluginOutList, JsonApiDatasetOutList, JsonApiFactOutList, JsonApiFilterContextOutList, JsonApiLabelOutList, JsonApiMetricOutList, JsonApiVisualizationObjectOutList } from "./generated/metadata-json-api";
/**
 ...
 * @internal
 */
export declare type MetadataGetEntitiesParams = {
    workspaceId: string;
};
/**
 * Common parameters for all API client getEntities* parameters.
 ...
 * @internal
 */
export declare type MetadataGetEntitiesResult = JsonApiVisualizationObjectOutList | JsonApiAnalyticalDashboardOutList | JsonApiDashboardPluginOutList | JsonApiDatasetOutList | JsonApiAttributeOutList | JsonApiLabelOutList | JsonApiMetricOutList | JsonApiFactOutList | JsonApiFilterContextOutList;
/**
