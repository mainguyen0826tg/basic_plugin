 ...
 */
export declare type QueryProcessingModule = {
    /**
...
declare type QueryEnvelopeEventHandlers<TQuery extends IDashboardQuery> = {
    onStart: (query: TQuery) => void;
    onSuccess: (result: IDashboardQueryResult<TQuery>) => void;
    onError: (err: Error) => void;
};
declare type QueryEnvelope<TQuery extends IDashboardQuery> = Readonly<QueryEnvelopeEventHandlers<TQuery>> & {
 ...
 * @internal
 */
export declare function queryEnvelope<TQuery extends IDashboardQuery>(query: TQuery, eventHandlers?: Partial<QueryEnvelopeEventHandlers<TQuery>>, refresh?: boolean): QueryEnvelope<TQuery>;
/**
 * @internal
 */
export declare function queryEnvelopeWithPromise<TQuery extends IDashboardQuery>(query: TQuery, refresh?: boolean): {
...
export {};
//# sourceMappingURL=queryProcessing.d.ts.map