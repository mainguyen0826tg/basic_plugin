import { IAnalyticalBackend, IExecutionFactory, IWorkspaceCatalogFactory, IWorkspaceAttributesService, IWorkspaceSettingsService, ISecuritySettingsService } from "@gooddata/sdk-backend-spi";
/**
 * @alpha
 */
 ...
 * @alpha
 */
export declare type WorkspaceSettingsDecoratorFactory = (settings: IWorkspaceSettingsService) => IWorkspaceSettingsService;
/**
 * @alpha
 */
