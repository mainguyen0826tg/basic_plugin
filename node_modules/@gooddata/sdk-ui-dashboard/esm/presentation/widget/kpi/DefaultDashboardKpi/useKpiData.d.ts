 ...
 * @internal
 */
export declare function useKpiData({ kpiWidget, filters, dashboardFilters, backend, workspace, }: IUseKpiDataConfig): UseCancelablePromiseState<IUseKpiDataResult, GoodDataSdkError>;
export {};
