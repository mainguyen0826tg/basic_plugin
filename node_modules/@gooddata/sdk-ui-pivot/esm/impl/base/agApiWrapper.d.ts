...
declare function setPinnedTopRowStyle(gridApi: GridApi, propertyName: string, propertyValue: string): void;
declare function getPinnedTopRowCellElementWrapper(gridApi: GridApi, attributeId: string): HTMLElement | null;
declare function getPinnedTopRowCellElement(gridApi: GridApi, attributeId: string): HTMLElement | null;
declare const _default: {
    ...
    setPinnedTopRowStyle: typeof setPinnedTopRowStyle;
    getPinnedTopRowCellElement: typeof getPinnedTopRowCellElement;
    getPinnedTopRowCellElementWrapper: typeof getPinnedTopRowCellElementWrapper;
