...
export function resolveDashboardConfig(ctx, cmd) {
    var _a, config, _b, dateFilterConfig, settings, colorPalette, _c, validDateFilterConfig, configValidation, resolvedConfig;
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            ...
            case 1:
                _b = __read.apply(void 0, [_k.sent(), 3]), dateFilterConfig = _b[0], settings = _b[1], colorPalette = _b[2];
                _c = __read(getValidDateFilterConfig(dateFilterConfig, settings), 2), validDateFilterConfig = _c[0], configValidation = _c[1];
            ...
            case 3:
                resolvedConfig = {
                    ...
                    objectAvailability: (_d = config.objectAvailability) !== null && _d !== void 0 ? _d : {},
                    mapboxToken: config.mapboxToken,
                    isReadOnly: (_e = config.isReadOnly) !== null && _e !== void 0 ? _e : false,
                    isEmbedded: (_f = config.isEmbedded) !== null && _f !== void 0 ? _f : false,
                    isExport: (_g = config.isExport) !== null && _g !== void 0 ? _g : false,
                    disableDefaultDrills: (_h = config.disableDefaultDrills) !== null && _h !== void 0 ? _h : false,
                    enableFilterValuesResolutionInDrillEvents: (_j = config.enableFilterValuesResolutionInDrillEvents) !== null && _j !== void 0 ? _j : false,
                };
