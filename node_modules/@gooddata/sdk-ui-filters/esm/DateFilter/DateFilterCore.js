...
export var DateFilterCore = function (_a) {
    var originalSelectedFilterOption = _a.originalSelectedFilterOption, originalExcludeCurrentPeriod = _a.originalExcludeCurrentPeriod, onDropdownOpenChanged = _a.onDropdownOpenChanged, customFilterName = _a.customFilterName, dateFormat = _a.dateFormat, disabled = _a.disabled, locale = _a.locale, filterOptions = _a.filterOptions, dropdownBodyProps = __rest(_a, ["originalSelectedFilterOption", "originalExcludeCurrentPeriod", "onDropdownOpenChanged", "customFilterName", "dateFormat", "disabled", "locale", "filterOptions"]);
    ...
    return (React.createElement(IntlWrapper, { locale: locale || "en-US" },
        React.createElement(MediaQuery, { query: MediaQueries.IS_MOBILE_DEVICE }, function (isMobile) {
            var dateFilterButton = function (isOpen) {
                ...
                return (React.createElement(DateFilterButtonLocalized, { disabled: disabled, isMobile: isMobile, isOpen: isOpen, dateFilterOption: applyExcludeCurrentPeriod(originalSelectedFilterOption, originalExcludeCurrentPeriod), dateFormat: verifiedDateFormat, customFilterName: customFilterName }));
            };
            return (React.createElement(Dropdown, { closeOnParentScroll: true, closeOnMouseDrag: true, closeOnOutsideClick: true, enableEventPropagation: true, alignPoints: [
                    ...
                    return (React.createElement("span", { onClick: disabled ? function () { } : toggleDropdown }, dateFilterButton(isOpen)));
                    ...
                    React.createElement(DateFilterBody, __assign({}, dropdownBodyProps, { filterOptions: filteredFilterOptions, isMobile: isMobile, closeDropdown: closeDropdown, dateFilterButton: dateFilterButton(), dateFormat: verifiedDateFormat })));
                } }));
        })));
};
