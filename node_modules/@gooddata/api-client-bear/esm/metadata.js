...
var MetadataModule = /** @class */ (function () {
     ...
     */
    MetadataModule.prototype.getAnalyticalDashboards = function (projectId) {
        return this.xhr
            .getParsed("/gdc/md/" + projectId + "/query/analyticaldashboard?showAll=0")
            .then(function (dashboardsQuery) {
