...
export declare const SaveAsDialogRendererIntl: React.ForwardRefExoticComponent<Pick<ISaveAsDialogRendererOwnProps & WrappedComponentProps<"intl">, "locale" | "onCancel" | "onSubmit" | "dashboardTitle" | "isDashboardSaving" | "isDashboardLoaded" | "isKpiWidgetEnabled" | "isScheduleEmailsEnabled"> & {
    forwardedRef?: React.RefObject<any> | ((instance: any) => void) | null | undefined;
} & React.RefAttributes<any>> & {
    WrappedComponent: React.ComponentType<ISaveAsDialogRendererOwnProps & WrappedComponentProps<"intl">>;
};
export declare const SaveAsDialogRenderer: React.FC<ISaveAsDialogRendererOwnProps>;
export {};
//# sourceMappingURL=SaveAsDialogRenderer.d.ts.map