...
import { CaseReducer, EntityId, EntityState, OutputSelector, PayloadAction, Reducer } from "@reduxjs/toolkit";
 ...
 * @internal
 */
declare type QueryCacheEntryResult<TResult> = {
    /**
     *
     */
 ...
 * @internal
 */
declare type QueryCacheEntry<TQuery extends IDashboardQuery<TResult>, TResult> = QueryCacheEntryResult<TResult> & {
    query: TQuery;
};
/**
 ...
 */
declare type QueryCacheReducer<TQuery extends IDashboardQuery<TResult>, TResult, TPayload> = CaseReducer<EntityState<QueryCacheEntry<TQuery, TResult>>, PayloadAction<TPayload>>;
/**
 * This defines all possible reducers for the cache slice.
 */
declare type AllQueryCacheReducers<TQuery extends IDashboardQuery<TResult>, TResult> = {
    /**
 ...
 */
declare type QueryActions<TQuery extends IDashboardQuery, TResult> = CaseReducerActions<AllQueryCacheReducers<TQuery, TResult>>;
/**
 * Contains all essentials of query cache that can be integrated into redux store and redux sagas.
 */
declare type QueryCache<TQuery extends IDashboardQuery<TResult>, TResult> = {
    /**
     ...
     * @param id - cache key
     */
    selectById: (id: EntityId) => OutputSelector<DashboardState, QueryCacheEntryResult<TResult> | undefined, (res: DashboardState) => QueryCacheEntryResult<TResult> | undefined>;
    /**
     ...
     * @internal
     */
    selectQueryResult: (query: TQuery) => OutputSelector<DashboardState, QueryCacheEntryResult<TResult> | undefined, (res: DashboardState) => QueryCacheEntryResult<TResult> | undefined>;
};
/**
 ...
 */
export declare function createCachedQueryService<TQuery extends IDashboardQuery<TResult>, TResult>(queryName: DashboardQueryType, generator: (ctx: DashboardContext, query: TQuery) => SagaIterator<TResult>, queryToCacheKey: (query: TQuery) => EntityId): Required<IDashboardQueryService<TQuery, TResult>>;
/**
 ...
 * @param generator - the generator function that processes the query
 */
export declare function createQueryService<TQuery extends IDashboardQuery<TResult>, TResult>(queryName: DashboardQueryType, generator: (ctx: DashboardContext, query: TQuery) => SagaIterator<TResult>): IDashboardQueryService<TQuery, TResult>;
export {};
