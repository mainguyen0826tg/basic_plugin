 ...
 * @internal
 */
export var AddGranteeBase = function (props) {
    var availableGrantees = props.availableGrantees, addedGrantees = props.addedGrantees, isDirty = props.isDirty, onCancel = props.onCancel, onSubmit = props.onSubmit, onBackClick = props.onBackClick, onAddUserOrGroups = props.onAddUserOrGroups, onDelete = props.onDelete;
    var intl = useIntl();
    var backButtonRenderer = useCallback(function () {
    ...
    return (React.createElement(ConfirmDialogBase, { className: "gd-share-dialog gd-share-dialog-add-users s-gd-share-add-grantees", displayCloseButton: true, isPositive: true, isSubmitDisabled: !isDirty, headline: intl.formatMessage({ id: "shareDialog.share.grantee.add.info" }), cancelButtonText: intl.formatMessage({ id: "cancel" }), submitButtonText: intl.formatMessage({ id: "shareDialog.share.grantee.share" }), onCancel: onBackClick, onSubmit: onSubmit, onClose: onCancel, headerLeftButtonRenderer: backButtonRenderer },
        React.createElement(AddGranteeContent, { addedGrantees: addedGrantees, availableGrantees: availableGrantees, onAddUserOrGroups: onAddUserOrGroups, onDelete: onDelete }),
