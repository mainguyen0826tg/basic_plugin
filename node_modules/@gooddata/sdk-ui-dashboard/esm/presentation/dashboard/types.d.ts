...
import { IAnalyticalBackend, IDashboard, IDashboardAttributeFilter, IInsightWidget, IKpiWidget, ILegacyKpi, ITheme, IWorkspacePermissions } from "@gooddata/sdk-backend-spi";
import { IInsight, ObjRef } from "@gooddata/sdk-model";
import { IErrorProps, ILoadingProps } from "@gooddata/sdk-ui";
import { DashboardConfig, DashboardDispatch, DashboardEventHandler, DashboardModelCustomizationFns, DashboardState, ExtendedDashboardWidget } from "../../model";
import { CustomDashboardAttributeFilterComponent, CustomDashboardDateFilterComponent, CustomFilterBarComponent } from "../filterBar";
...
import { CustomDashboardInsightComponent, CustomDashboardInsightMenuButtonComponent, CustomDashboardInsightMenuComponent, CustomDashboardKpiComponent, CustomDashboardWidgetComponent, IInsightMenuItem } from "../widget";
 ...
 * @alpha
 */
export declare type InsightMenuButtonComponentProvider = (insight: IInsight, widget: IInsightWidget) => CustomDashboardInsightMenuButtonComponent | undefined;
/**
 * @alpha
 */
export declare type InsightMenuComponentProvider = (insight: IInsight, widget: IInsightWidget) => CustomDashboardInsightMenuComponent | undefined;
/**
 * @alpha
 */
export declare type InsightMenuItemsProvider = (insight: IInsight, widget: IInsightWidget, defaultItems: IInsightMenuItem[], closeMenu: () => void) => IInsightMenuItem[];
/**
 * @public
 */
export declare type KpiComponentProvider = (kpi: ILegacyKpi, widget: IKpiWidget) => CustomDashboardKpiComponent;
/**
 * @public
 */
 ...
 * @alpha
 */
export declare type AttributeFilterComponentProvider = (filter: IDashboardAttributeFilter) => CustomDashboardAttributeFilterComponent | undefined;
/**
 ...
 * @public
 */
export declare type IDashboardExtensionProps = IDashboardEventing & IDashboardCustomizationProps & IDashboardThemingProps & {
    /**
