 ...
 * @internal
 */
export declare const selectPersistedDashboard: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-backend-spi").IDashboard<import("@gooddata/sdk-backend-spi").IDashboardWidget> | undefined, (res: import("./metaState").DashboardMetaState) => import("@gooddata/sdk-backend-spi").IDashboard<import("@gooddata/sdk-backend-spi").IDashboardWidget> | undefined>;
/**
 ...
 * been persisted (typically newly created dashboard being edited).
 */
export declare const selectPersistedDashboardFilterContext: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-backend-spi").IFilterContext | import("@gooddata/sdk-backend-spi").ITempFilterContext | undefined, (res: import("./metaState").DashboardMetaState) => import("@gooddata/sdk-backend-spi").IFilterContext | import("@gooddata/sdk-backend-spi").ITempFilterContext | undefined>;
/**
 ...
 * @public
 */
export declare const selectDashboardRef: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined, (res: import("@gooddata/sdk-backend-spi").IDashboard<import("@gooddata/sdk-backend-spi").IDashboardWidget> | undefined) => import("@gooddata/sdk-model").UriRef | import("@gooddata/sdk-model").IdentifierRef | undefined>;
/**
 ...
 * @public
 */
export declare const selectDashboardId: import("@reduxjs/toolkit").OutputSelector<DashboardState, string | undefined, (res: import("@gooddata/sdk-backend-spi").IDashboard<import("@gooddata/sdk-backend-spi").IDashboardWidget> | undefined) => string | undefined>;
/**
 ...
 * @public
 */
export declare const selectDashboardUri: import("@reduxjs/toolkit").OutputSelector<DashboardState, string | undefined, (res: import("@gooddata/sdk-backend-spi").IDashboard<import("@gooddata/sdk-backend-spi").IDashboardWidget> | undefined) => string | undefined>;
/**
 ...
 * @alpha
 */
export declare const selectDashboardShareStatus: import("@reduxjs/toolkit").OutputSelector<DashboardState, import("@gooddata/sdk-backend-spi").ShareStatus, (res: import("./metaState").DashboardDescriptor) => import("@gooddata/sdk-backend-spi").ShareStatus>;
