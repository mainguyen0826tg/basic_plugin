...
import { DefaultLocale, pickCorrectInsightWording } from "@gooddata/sdk-ui";
...
export function createInternalIntl(locale) {
    ...
    return createIntl({ locale: locale, messages: pickCorrectInsightWording(translations[locale], settings) });
}
