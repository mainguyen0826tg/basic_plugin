...
export declare const QueryWidgetFiltersService: import("../store/_infra/queryService").IDashboardQueryService<QueryWidgetFilters, IFilter[]>;
/**
 ...
 */
export declare function isDateFilterIgnoredForInsight(insight: IInsight): boolean;
