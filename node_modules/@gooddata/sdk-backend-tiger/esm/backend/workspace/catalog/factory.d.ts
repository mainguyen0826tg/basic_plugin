import { IWorkspaceCatalog, IWorkspaceCatalogFactory, IWorkspaceCatalogFactoryOptions, CatalogItemType } from "@gooddata/sdk-backend-spi";
...
export declare class TigerWorkspaceCatalogFactory implements IWorkspaceCatalogFactory {
    ...
    private tagsToIdentifiers;
    private loadAttributesAndDates;
