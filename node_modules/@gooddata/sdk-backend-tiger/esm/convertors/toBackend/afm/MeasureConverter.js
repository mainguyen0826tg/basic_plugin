...
function convertSimpleMeasureDefinition(definition) {
    ...
    var filters = measureDefinition.filters
        ? compact(measureDefinition.filters.map(function (filter) { return convertFilter(filter); })) // measureDefinition.filters is IMeasureFilter, it contains only date and attribute filter, equally result contains this subset, it corresponds to type FilterDefinitionForSimpleMeasure
        : [];
