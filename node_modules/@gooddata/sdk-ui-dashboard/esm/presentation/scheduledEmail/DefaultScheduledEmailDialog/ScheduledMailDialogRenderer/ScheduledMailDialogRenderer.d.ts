...
export declare const ScheduledMailDialogRendererIntl: React.ForwardRefExoticComponent<Pick<IScheduledMailDialogRendererProps, "canListUsersInProject" | "locale" | "onError" | "onCancel" | "backend" | "dateFormat" | "onSubmit" | "dashboard" | "dashboardTitle" | "currentUser" | "enableKPIDashboardScheduleRecipients" | "workspace"> & {
