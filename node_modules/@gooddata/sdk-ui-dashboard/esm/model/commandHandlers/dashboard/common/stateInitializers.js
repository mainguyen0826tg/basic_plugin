...
export function actionsToInitializeExistingDashboard(ctx, dashboard, insights, settings, dateFilterConfig, displayForms) {
    var sanitizedDashboard, privateCtx, customizedDashboard, filterContextDefinition, filterContextIdentity, attributeFilterDisplayForms, dashboardLayout;
    var _a, _b, _c, _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                sanitizedDashboard = __assign(__assign({}, dashboard), { layout: (_a = dashboard.layout) !== null && _a !== void 0 ? _a : EmptyDashboardLayout });
