 ...
 */
export declare function query<TResult>(q: IDashboardQuery<TResult>, refresh?: boolean): SagaIterator<TResult>;
/**
 * Runs the provided query, forcing refresh of any results that may be cached in the state, and returns its result.
 *
 * @param q - query to run
 */
export declare function queryFresh<TResult>(q: IDashboardQuery<TResult>): SagaIterator<TResult>;
//# sourceMappingURL=queryCall.d.ts.map