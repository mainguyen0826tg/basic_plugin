...
.attribute-filter-button.is-active .button-title::after,
...
.gd-mobile-dropdown-content .gd-attribute-filter-button-mobile::after {
  display: none; }

.gd-mobile-dropdown-content .gd-attribute-filter-button-mobile::before {
  right: 4px; }
...
.gd-powered-by-logo-img {
  ...
  .gd-powered-by-logo-img-large {
    width: 165px;
    height: 30px;
    background-image: url("~@gooddata/sdk-ui-dashboard/esm/assets/powered-by-gd-large.svg");
    background-size: 165px 30px; }
  .gd-powered-by-logo-img-small {
    width: 146px;
    height: 16px;
    background-image: url("~@gooddata/sdk-ui-dashboard/esm/assets/powered-by-gd-small.svg");
