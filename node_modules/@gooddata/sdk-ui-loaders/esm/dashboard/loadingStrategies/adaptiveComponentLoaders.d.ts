 ...
 * @internal
 */
export declare const adaptiveDashboardEngineLoaderFactory: (moduleFederationIntegration: ModuleFederationIntegration) => (dashboard: IDashboardWithReferences) => Promise<IDashboardEngine>;
/**
 ...
 * @internal
 */
export declare const adaptiveDashboardPluginLoaderFactory: (moduleFederationIntegration: ModuleFederationIntegration) => (ctx: DashboardContext, dashboard: IDashboardWithReferences) => Promise<LoadedPlugin[]>;
/**
 * Adaptive loader will check if there are any plugins linked with the dashboard. If so, it will use
 ...
 * @internal
 */
export declare const adaptiveDashboardBeforeLoadFactory: (_moduleFederationIntegration: ModuleFederationIntegration) => (ctx: DashboardContext, dashboard: IDashboardWithReferences) => Promise<void>;
//# sourceMappingURL=adaptiveComponentLoaders.d.ts.map