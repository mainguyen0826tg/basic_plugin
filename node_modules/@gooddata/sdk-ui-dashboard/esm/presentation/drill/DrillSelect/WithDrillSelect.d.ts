...
import { OnWidgetDrill, OnDrillDownSuccess, OnDrillToAttributeUrlSuccess, OnDrillToCustomUrlSuccess, OnDrillToDashboardSuccess, OnDrillToInsightSuccess } from "../types";
import { IInsight, ObjRef } from "@gooddata/sdk-model";
/**
 * @internal
 */
export declare type WithDrillSelectProps = {
    widgetRef: ObjRef;
    insight: IInsight;
