...
export var CompactContentError = function (_a) {
    var className = _a.className, headline = _a.headline, text = _a.text;
    return (React.createElement(BubbleHoverTrigger, null,
        ...
        React.createElement(Bubble, { alignPoints: bubbleAlignPoints },
            React.createElement(FormattedHTMLMessage, { id: headline }),
            React.createElement("br", null),
            React.createElement(FormattedHTMLMessage, { id: text }))));
};
