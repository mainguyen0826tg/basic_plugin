import { IAnalyticalBackend, IPreparedExecution, FilterContextItem } from "@gooddata/sdk-backend-spi";
 ...
 * @deprecated superseded by Dashboard component; please see `@gooddata/sdk-ui-dashboard` and GoodData.UI documentation for v8.7
 */
export declare function useDashboardWidgetExecution({ dashboard, widget: widgetRef, filters, backend, workspace, }: IUseDashboardWidgetExecutionConfig): UseCancelablePromiseState<IPreparedExecution, GoodDataSdkError>;
//# sourceMappingURL=useDashboardWidgetExecution.d.ts.map