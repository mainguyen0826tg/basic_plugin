...
var CorePivotTableAgImpl = /** @class */ (function (_super) {
    ...
    function CorePivotTableAgImpl(props) {
        ...
        _this.onContainerMouseDown = function (event) {
            if (event.target && isHeaderResizer(event.target)) {
        ...
        _this.onMenuAggregationClick = function (menuAggregationClickConfig) {
            var newColumnTotals = getUpdatedColumnTotals(_this.getColumnTotals(), menuAggregationClickConfig);
            _this.pushDataGuard({
                properties: {
        ...
        _this.getResizingConfig = function () {
            ...
            return {
                ...
                clientWidth: (_b = (_a = _this.containerRef) === null || _a === void 0 ? void 0 : _a.clientWidth) !== null && _b !== void 0 ? _b : 0,
                containerRef: _this.containerRef,
                separators: (_d = (_c = _this.props) === null || _c === void 0 ? void 0 : _c.config) === null || _d === void 0 ? void 0 : _d.separators,
    ...
    CorePivotTableAgImpl.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "gd-table-component", style: style, id: this.pivotTableId },
