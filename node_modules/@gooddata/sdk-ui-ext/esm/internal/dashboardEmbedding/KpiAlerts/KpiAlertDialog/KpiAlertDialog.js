...
var KpiAlertDialog = /** @class */ (function (_super) {
    ...
    function KpiAlertDialog(props) {
        ...
        _this.applyAlertFilterSetting = function () {
            setTimeout(function () {
                _this.props.onApplyAlertFiltersClick();
            }, 0);
        };
        _this.state = {
    ...
    KpiAlertDialog.prototype.getVisualThreshold = function (props) {
        ...
        var threshold = this.isThresholdRepresentingPercent(props)
            ? thresholdFromDecimalToPercent((_a = props.alert) === null || _a === void 0 ? void 0 : _a.threshold)
            : (_b = props.alert) === null || _b === void 0 ? void 0 : _b.threshold;
    ...
    KpiAlertDialog.prototype.renderDialogContent = function () {
        ...
        var emailMe = (React.createElement("span", { className: "underline-dotted", title: this.props.userEmail },
            React.createElement(FormattedHTMLMessage, { id: "kpiAlertDialog.emailMe" })));
        return (React.createElement("div", { className: "kpi-alert-dialog-content" },
            ...
            React.createElement("div", { className: "input-container" },
                React.createElement(Input, { className: "s-threshold-input", hasError: hasError, isSmall: true, maxlength: 16, onChange: this.onChange, onEscKeyPress: this.closeDialog, onEnterKeyPress: this.saveKpiAlert, placeholder: this.props.thresholdPlaceholder, ref: this.threshold, suffix: inputSuffix, value: threshold })),
    ...
    KpiAlertDialog.prototype.renderFiltersDifferMessage = function () {
        ...
        return shouldShowFiltersDifferMessage ? (React.createElement(Message, { type: "warning" },
            React.createElement(FormattedHTMLMessage, { id: "kpiAlertDialog.filtersDiffer" }),
            !!this.props.onApplyAlertFiltersClick && (React.createElement(React.Fragment, null,
                ...
                React.createElement("a", { className: "s-apply-alert-filters", onClick: this.applyAlertFilterSetting },
                    React.createElement(FormattedHTMLMessage, { id: "kpiAlertDialog.filtersApply" })))))) : (false);
    };
    KpiAlertDialog.prototype.renderErrorMessage = function (messageId) {
        return (React.createElement(Message, { type: "error" },
            React.createElement(FormattedHTMLMessage, { id: messageId })));
    };
