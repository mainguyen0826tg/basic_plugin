...
export function getTranslatedDropdownItems(dropdownItems, intl) {
    return dropdownItems.map(function (item) {
        ...
        var translatedInfoProp = item.info ? { info: getTranslation(item.info, intl) } : {};
        return __assign(__assign(__assign({}, item), translatedTitleProp), translatedInfoProp);
    });
}
var sdkUiExtTranslations = {
 ...
 * @internal
 */
export var translations = merge(sdkUiTranslations, // we use also some of the sdk-ui strings here so we need to merge them in here
