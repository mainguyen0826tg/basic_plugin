 ...
 */
export var removeFromDom = function (element) {
 ...
 */
export var region = function (element, ignoreScrollOffsets, windowObject) {
 ...
 * @returns {boolean}
 */
export var isFixedPosition = function (element) {
 ...
 */
export var elementRegion = function (elementOrSelector, getRegionBasedOnPosition) {
    var elem = typeof elementOrSelector === "string"
