...
export function useDashboardLoader(options) {
    ...
    var dashboard = options.dashboard, filterContextRef = options.filterContextRef, config = options.config, permissions = options.permissions, clientWorkspace = options.clientWorkspace, loadingMode = options.loadingMode, extraPlugins = options.extraPlugins, adaptiveLoadOptions = options.adaptiveLoadOptions;
    useEffect(function () {
        return function () {
