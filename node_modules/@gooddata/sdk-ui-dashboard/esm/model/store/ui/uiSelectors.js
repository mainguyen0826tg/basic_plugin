 ...
 * @internal
 */
export var selectFilterBarHeight = createSelector(selectSelf, function (state) { return state.filterBar.height; });
/**
 * @alpha
 */
...
var selectOpenedKpiWidgetRef = createSelector(selectSelf, function (state) { return state.kpiAlerts.openedWidgetRef; });
/**
 * @alpha
 */
