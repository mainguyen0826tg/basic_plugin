...
import { DefaultLocale, pickCorrectInsightWording, TranslationsCustomizationProvider, } from "@gooddata/sdk-ui";
import { translations } from "./translations";
import LRUCache from "lru-cache";
var INTL_CACHE_SIZE = 20;
var INTL_CACHE_KEY = "messages";
var intlCache = new LRUCache({ max: INTL_CACHE_SIZE });
...
export var InternalIntlWrapper = function (_a) {
    ...
    var settings = window.gdSettings;
    if (settings) {
        var messages = useMemo(function () { return pickCorrectInsightWording(translations[locale], settings); }, [locale, settings, translations]);
