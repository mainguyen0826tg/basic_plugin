    ...
    function RecipientsSelectRenderer() {
        ...
        _this.handleOnChange = function (selectedValues, actionTypes) {
            ...
            if (selectedValues === null) {
                (_d = (_c = _this.props).onChange) === null || _d === void 0 ? void 0 : _d.call(_c, [value[0]]);
                return;
            }
            (_f = (_e = _this.props).onChange) === null || _f === void 0 ? void 0 : _f.call(_e, selectedValues);
        };
    ...
    RecipientsSelectRenderer.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "gd-input-component gd-recipients-field s-gd-schedule-email-dialog-recipients" },
            ...
            React.createElement("div", { ref: this.recipientRef, className: "gd-input s-gd-recipients-value" },
                React.createElement(CreatableSelect, { cacheOptions: true, className: "gd-recipients-container", classNamePrefix: "gd-recipients", components: creatableSelectComponent, getNewOptionData: this.getNewOptionData, formatOptionLabel: this.renderOptionLabel, isClearable: false, isDisabled: !isMulti, isMulti: isMulti, onChange: 
