...
var DashboardCustomizationBuilder = /** @class */ (function () {
    function DashboardCustomizationBuilder() {
        ...
        this.build = function () {
            var props = {
                InsightComponentProvider: _this.insightCustomizer.getInsightProvider(),
                KpiComponentProvider: _this.kpiCustomizer.getKpiProvider(),
                WidgetComponentProvider: _this.widgetCustomizer.getWidgetComponentProvider(),
                customizationFns: {
